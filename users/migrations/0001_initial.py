    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town', models.CharField(blank=True, help_text='Укажите из какого города', max_length=50, null=True, verbose_name='Город')),
                ('avatar', models.ImageField(blank=True, help_text='Загрузите аватарку', null=True, upload_to='users/avatar', verbose_name='Аватарка')),
